...
static class CommonDefinitions
{
    ...
    internal static string AmTera => Instance.TeraTaxDeck.UniqueName;
    internal static Deck AmTeraDeck => Instance.TeraTaxDeck.Deck;
    ...
    internal const string AmDrakeEnemy = "pirate";
