 ...
 */
public class YearlyPayments : Artifact, IRegisterable
{
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Artifacts.RegisterArtifact(new ArtifactConfiguration
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["artifact", "YearlyPayments", "name"]).Localize,
            Description = ModEntry.Instance.AnyLocalizations.Bind(["artifact", "YearlyPayments", "desc"]).Localize,
            /*
             * For Artifacts with just one sprite, registering them at the place of usage helps simplify things.
             */
            Sprite = helper.Content.Sprites.RegisterSprite(package.PackageRoot.GetRelativeFile("assets/Artifact/YearlyPayments.png")).Sprite
        });
    }
